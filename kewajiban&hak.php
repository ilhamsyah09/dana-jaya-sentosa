...
<div class="middle-content">
    <section class="inside_section_1 pg_kewajiban_hak bg-dark-green">
    ...
    <section class="inside_section_2 pg_kewajiban_hak bg-dark-orange">
        <div class="custom container">
            <div class="inside-content">
    ...
    <section class="inside_section_3 pg_kewajiban_hak">
        <div class="custom container">
